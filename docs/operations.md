...
`granite-net-packet-pipe` is centered on networking work in TypeScript. The technical target is: Design a TypeScript verification harness for packet systems, covering stream reduction, windowed input fixtures, and failure-oriented tests.
...
The score is deterministic. The current threshold is 179. Risk has a penalty of 7, latency has a penalty of 3, and weight contributes a bonus of 5.
